        ...
        <div className={`category-filter ${showFilter ? '' : 'hidden'}`}>
          ...
          <div className='categorise'>
            <p className='categorise-content'>
              <input type='checkbox' value={'Bedsheet'} onClick={toggleCategory} /> BedSheet
            </p>
            <p className='categorise-content'>
              <input type='checkbox' value={'Towel'} onClick={toggleCategory} /> Towel
            </p>
            <p className='categorise-content'>
              <input type='checkbox' value={'KitchenNapkin'} onClick={toggleCategory} /> Kitchen Napkin
            </p>
          </div>
        </div>
          ...
          <div className='collection-products'>
              {
                filterProducts.map((item,index)=>(
                  <ProductItem key={index} name={item.name} id={item._id} price={item.discountPrice} image={item.image}/>
                ))
              }
          </div>
      </div>
